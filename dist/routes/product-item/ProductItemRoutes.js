...
productItemRoutes.get('/products/:productId/items', _ProductItemController2.default.index)
productItemRoutes.get('/products/:productId/items/:productItemId', _ProductItemController2.default.get)
